...
L2Data = rbind(Data1[,c(2,3,4)],Data2[,c(2,3,4)],Data3[,c(2,3,4)],Data4[,c(2,3,4)],Data5[,c(2,3,4)],Data6[,c(2,3,4)])


colnames(L2Data) = c("Dimension","Method","LossVal")
L2Data["ModelName"] = c(rep("Model1",3600),rep("Model2",3600),rep("Model3",3600),rep("Model4",3600),
...
main=textGrob("L2",gp=gpar(fontsize=14,font=2))
...
pdf("L2.pdf", height=height, width=width)
grid.arrange(arrangeGrob(p1,p2,p3,p4,p5,p6 + theme(legend.position='none'),nrow=2,ncol=3),
             mylegend, nrow=2,heights=c(10,1),top=main)
dev.off()