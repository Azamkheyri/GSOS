...
SPData = rbind(Data1[,c(2,3,5)],Data2[,c(2,3,5)],Data3[,c(2,3,5)],Data4[,c(2,3,5)],Data5[,c(2,3,5)],Data6[,c(2,3,5)])


colnames(SPData) = c("Dimension","Method","LossVal")
SPData["ModelName"] = c(rep("Model1",3600),rep("Model2",3600),rep("Model3",3600),rep("Model4",3600),
...
main=textGrob("SP",gp=gpar(fontsize=14,font=2))
...
pdf("SP.pdf", height=height, width=width)
grid.arrange(arrangeGrob(p1,p2,p3,p4,p5,p6 + theme(legend.position='none'),nrow=2,ncol=3),
             mylegend, nrow=2,heights=c(10,1),top=main)
dev.off()